...
public class Rectangle extends SurfaceShape {
	...
	public String toString() {
		return "Rectangle: (" + upperLeftPoint.getX() + ", " + upperLeftPoint.getY() + "), " + "Height=" +height+ ",Width="+width+ ", Inside Color: ("+Integer.toString(getInnerColor().getRGB())+")" + ", Outside Color: ("+Integer.toString(getColor().getRGB())+")";
	}
