		...
		}
		{
			...
			getContentPane().add(buttonPane, gbc_buttonPane);
			{
				...
				okButton.addActionListener(new ActionListener() {
					...
					/*	circle = new Circle(new Point(Integer.parseInt(txtX.getText().toString()),Integer.parseInt(txtY.getText().toString()))
								,Integer.parseInt(txtRadius.getText().toString()),false,borderColor,innerColor);*/
						confirmation=true;
						setVisible(false);
					}
				});
				{
					...
					btnInnerColor.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							innerColor=JColorChooser.showDialog(null, "Choose a color",Color.RED);
				...
				}
				{
					...
					btnBorderColor.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							borderColor=JColorChooser.showDialog(null, "Choose a color", Color.RED);
